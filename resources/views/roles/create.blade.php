            ...
            <form method="POST" action="{{ route('roles.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" name="name">
                        ...
                        <option value="Direction Exploitations">Direction Exploitations</option>
                        <option value="Direction Engagements">Direction Engagements</option>
                        <option value="Chef d'agence">Chef d'agence</option>
                        <option value="Chargee client">Chargee client</option>
