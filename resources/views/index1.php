...
<head>
  ...
  <title>BTLADMIN 3 | Dashboard</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src=" {{ asset('images/btl logo.png') }} " alt="AdminLTELogo" height="60" width="60">
  </div>
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    ...
                    <li>
                      <a href="#">
                      <img class="contacts-list-img" src="{{ asset('assetsdist/img/user6-128x128.jpg') }}" alt="User Avatar">
...
<script src="{{ asset('asstes/dist/js/demo.js') }}"></script>
